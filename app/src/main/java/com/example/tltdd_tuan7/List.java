...
public class List extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        items.add(new Items("Bún bò","Đặc sản Huế",R.drawable.bunbo)) ;
        items.add(new Items("Phở gà","Đặc sản Hà Nội",R.drawable.phoga)) ;
        items.add(new Items("Bún riêu","Bún cực ngon",R.drawable.bunrieu)) ;
        items.add(new Items("Bún ốc","Bún cực ngon",R.drawable.bunoc)) ;
